  ...
  return (
    <div className='text-center bg-white text-gray-800 py-24 px-6'>
        <h1 className='text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12'>
            <span className='capitalize'>Bring creative projects to life on</span><br />
            <span className='uppercase text-green-600'>grandstar.</span>
        </h1>
        ...
        <button type='button' className='inline-block px-6 py-2.5 border border-green-600
            ...
            bg-transparent hover:bg-green-700 hover:text-white'>Back Projects</button>
        </div>

        <div className='flex justify-center items-center mt-10'>
            <div className='flex flex-col justify-center items-center h-20 border
            shadow-md w-full'>
